...
0000000000400fce <func4>:
  ...
  400fd4:	29 f0                	sub    %esi,%eax    ; ta = z - y
  400fd6:	89 c1                	mov    %eax,%ecx    ; tc = z - y
  400fd8:	c1 e9 1f             	shr    $0x1f,%ecx   ; tc >>= 31
  400fdb:	01 c8                	add    %ecx,%eax    
  400fdd:	d1 f8                	sar    %eax         ; ta = (z - y + cf)/2
  400fdf:	8d 0c 30             	lea    (%rax,%rsi,1),%ecx   ; tc = (z + y + cf) / 2
  400fe2:	39 f9                	cmp    %edi,%ecx    ; tc - x
  400fe4:	7e 0c                	jle    400ff2 <func4+0x24>  ; tc - x <= 0
  400fe6:	8d 51 ff             	lea    -0x1(%rcx),%edx    ; z = tc - 1
  400fe9:	e8 e0 ff ff ff       	callq  400fce <func4>   ; func4(x, y, z) until tc <= x
  400fee:	01 c0                	add    %eax,%eax
  400ff0:	eb 15                	jmp    401007 <func4+0x39>
  400ff2:	b8 00 00 00 00       	mov    $0x0,%eax    ; ta = 0
  400ff7:	39 f9                	cmp    %edi,%ecx    ; tc - x
  400ff9:	7d 0c                	jge    401007 <func4+0x39>    ; tc - x >= 0
  400ffb:	8d 71 01             	lea    0x1(%rcx),%esi   ; y = tc + 1
...
0000000000401062 <phase_5>:
  ...
  40108b:	0f b6 0c 03          	movzbl (%rbx,%rax,1),%ecx   ; tc = input[i] i = 0..5
  40108f:	88 0c 24             	mov    %cl,(%rsp)   ; (%rsp) = input[i]
  401092:	48 8b 14 24          	mov    (%rsp),%rdx  ; %rdx = input[i]
  401096:	83 e2 0f             	and    $0xf,%edx    ; %edx 保留最低四位
  401099:	0f b6 92 b0 24 40 00 	movzbl 0x4024b0(%rdx),%edx    ; %edx = (0x4024b0+%edx)
  4010a0:	88 54 04 10          	mov    %dl,0x10(%rsp,%rax,1)  ; 每次复制一个字符到(%rsp+16+i)
  4010a4:	48 83 c0 01          	add    $0x1,%rax
  4010a8:	48 83 f8 06          	cmp    $0x6,%rax
  4010ac:	75 dd                	jne    40108b <phase_5+0x29>
  4010ae:	c6 44 24 16 00       	movb   $0x0,0x16(%rsp)    ; 结尾加0
  4010b3:	be 5e 24 40 00       	mov    $0x40245e,%esi     
  4010b8:	48 8d 7c 24 10       	lea    0x10(%rsp),%rdi    ; 写入的字符和(0x40245e)相等
  ...
  4010de:	64 48 33 04 25 28 00 	xor    %fs:0x28,%rax    ; 检测是否越界
  4010e5:	00 00 
...
00000000004010f4 <phase_6>:
  ...
  401106:	e8 51 03 00 00       	callq  40145c <read_six_numbers>    ; (%rsp)为输入的6个数字
  40110b:	49 89 e6             	mov    %rsp,%r14
  40110e:	41 bc 00 00 00 00    	mov    $0x0,%r12d
  ; loop1 循环 5 次 说明input[0] - input[5] 各不相同
  401114:	4c 89 ed             	mov    %r13,%rbp    ; %rbp = %rsp + i  i = [0..5]
  401117:	41 8b 45 00          	mov    0x0(%r13),%eax   ; ta = input[i]
  40111b:	83 e8 01             	sub    $0x1,%eax    ; ta = ta - 1
  40111e:	83 f8 05             	cmp    $0x5,%eax    ; ta - 5
  401121:	76 05                	jbe    401128 <phase_6+0x34>    ; ta - 5 <= 0 <=> input[i] <= 6
  401123:	e8 12 03 00 00       	callq  40143a <explode_bomb>
  401128:	41 83 c4 01          	add    $0x1,%r12d   ; %r12d = j [0..5]
  40112c:	41 83 fc 06          	cmp    $0x6,%r12d   ; r12d - 6
  401130:	74 21                	je     401153 <phase_6+0x5f>
  401132:	44 89 e3             	mov    %r12d,%ebx   ; ebx = [1..5]
  ; loop2
  401135:	48 63 c3             	movslq %ebx,%rax    ; ta = %ebx   ta = [1..5]
  401138:	8b 04 84             	mov    (%rsp,%rax,4),%eax   ; ta = %rsp[ta]
  40113b:	39 45 00             	cmp    %eax,0x0(%rbp)   ; (%rsp + i) - ta
  40113e:	75 05                	jne    401145 <phase_6+0x51>    ; input[i] != input[i + 1..5]
  ...
  401158:	4c 89 f0             	mov    %r14,%rax    ; ta = %r14 (从%rsp开始)
  40115b:	b9 07 00 00 00       	mov    $0x7,%ecx    ; tc = 7
  ; loop3 input[i] = 7 - input[i] i = 0..5
  401160:	89 ca                	mov    %ecx,%edx    ; td = 7
  401162:	2b 10                	sub    (%rax),%edx    ; 
  401164:	89 10                	mov    %edx,(%rax)    ; ta[0] = 7 - ta[0]
  401166:	48 83 c0 04          	add    $0x4,%rax    ; ta = ta + 4
  40116a:	48 39 f0             	cmp    %rsi,%rax    ; ta - %rsp - 24
  40116d:	75 f1                	jne    401160 <phase_6+0x6c> ; ta = %rsp + 0 4 .. 20
  ; loop3 end
  40116f:	be 00 00 00 00       	mov    $0x0,%esi    ; %esi = 0
  401174:	eb 21                	jmp    401197 <phase_6+0xa3>
  ; %rsp+32位置开始依次记录%rsp[i]与1的差距
  401176:	48 8b 52 08          	mov    0x8(%rdx),%rdx   ; td = (td + 8)
  40117a:	83 c0 01             	add    $0x1,%eax    ; ta = ta + 1
  40117d:	39 c8                	cmp    %ecx,%eax    ; ta - tc
  40117f:	75 f5                	jne    401176 <phase_6+0x82>    ; ta != tc
  401181:	eb 05                	jmp    401188 <phase_6+0x94> 

  401183:	ba d0 32 60 00       	mov    $0x6032d0,%edx   ; %edx = 0x6032d0
  401188:	48 89 54 74 20       	mov    %rdx,0x20(%rsp,%rsi,2)   ; %rsp[2*%rsi + 32] = td    // 每次增幅为8
  40118d:	48 83 c6 04          	add    $0x4,%rsi    ; %rsi = %rsi + 4
  401191:	48 83 fe 18          	cmp    $0x18,%rsi   ; %rsi - 24
  401195:	74 14                	je     4011ab <phase_6+0xb7>

  401197:	8b 0c 34             	mov    (%rsp,%rsi,1),%ecx   ; tc = %rsp[%rsi]
  40119a:	83 f9 01             	cmp    $0x1,%ecx    
  40119d:	7e e4                	jle    401183 <phase_6+0x8f>    ; tc <= 1 只能是6
  40119f:	b8 01 00 00 00       	mov    $0x1,%eax    ; ta = 1
  4011a4:	ba d0 32 60 00       	mov    $0x6032d0,%edx   ; td = 0x6032d0
  4011a9:	eb cb                	jmp    401176 <phase_6+0x82>
  ; ============================================================
  ; 按照输入排列链表
  4011ab:	48 8b 5c 24 20       	mov    0x20(%rsp),%rbx    
  4011b0:	48 8d 44 24 28       	lea    0x28(%rsp),%rax    ; ta = %rsp + 40
  4011b5:	48 8d 74 24 50       	lea    0x50(%rsp),%rsi    ; %rsi = %rsp + 80
  4011ba:	48 89 d9             	mov    %rbx,%rcx    ; tc = (%rsp+32)

  4011bd:	48 8b 10             	mov    (%rax),%rdx  ; td = (ta)
  4011c0:	48 89 51 08          	mov    %rdx,0x8(%rcx)   ; (tc + 8) = (ta)
  4011c4:	48 83 c0 08          	add    $0x8,%rax    ; ta = ta + 8
  4011c8:	48 39 f0             	cmp    %rsi,%rax    
  4011cb:	74 05                	je     4011d2 <phase_6+0xde>    ; ta == %rsi <=> 循环5次
  4011cd:	48 89 d1             	mov    %rdx,%rcx    ; tc = td
  4011d0:	eb eb                	jmp    4011bd <phase_6+0xc9>


  4011d2:	48 c7 42 08 00 00 00 	movq   $0x0,0x8(%rdx)
  4011d9:	00                                        ; tb = (%rsp + 32) 链表头地址
  4011da:	bd 05 00 00 00       	mov    $0x5,%ebp    ; %ebp = 5
  
  4011df:	48 8b 43 08          	mov    0x8(%rbx),%rax   ; ta = (tb + 8) 指向下一个链表节点
  4011e3:	8b 00                	mov    (%rax),%eax    ; ta = (ta)    下一个链表节点的值
  4011e5:	39 03                	cmp    %eax,(%rbx)    ; (tb) - ta    当表节点与下一节点对比，主意只比较低32位
  4011e7:	7d 05                	jge    4011ee <phase_6+0xfa>    ; 当前更大才不会爆炸，链表递减
  4011e9:	e8 4c 02 00 00       	callq  40143a <explode_bomb>
  4011ee:	48 8b 5b 08          	mov    0x8(%rbx),%rbx   ; tb = ta
...
; rdi = 0x6030f0 rsi = 输入的长整型数 ta = 输入的长整型数-1
0000000000401204 <fun7>:
  401204:	48 83 ec 08          	sub    $0x8,%rsp
  401208:	48 85 ff             	test   %rdi,%rdi
  40120b:	74 2b                	je     401238 <fun7+0x34>
  40120d:	8b 17                	mov    (%rdi),%edx    ; td = (rdi) (初始值36)
  40120f:	39 f2                	cmp    %esi,%edx    ; td - %rsi
  401211:	7e 0d                	jle    401220 <fun7+0x1c>   ; td <= %rsi 跳过
  401213:	48 8b 7f 08          	mov    0x8(%rdi),%rdi   ; %rdi = (%rdi + 8)
  401217:	e8 e8 ff ff ff       	callq  401204 <fun7> 
  40121c:	01 c0                	add    %eax,%eax    ; ta = ta * 2;
  40121e:	eb 1d                	jmp    40123d <fun7+0x39>   

  401220:	b8 00 00 00 00       	mov    $0x0,%eax    ; ta = 0
  401225:	39 f2                	cmp    %esi,%edx    ; td - %esi
  401227:	74 14                	je     40123d <fun7+0x39>   ; td == %esi break
  401229:	48 8b 7f 10          	mov    0x10(%rdi),%rdi    ; %rdi = (%rdi + 16)
  40122d:	e8 d2 ff ff ff       	callq  401204 <fun7>
  401232:	8d 44 00 01          	lea    0x1(%rax,%rax,1),%eax    ; ta = ta * 2 + 1
...
0000000000401242 <secret_phase>:
  ...
  40125a:	48 89 c3             	mov    %rax,%rbx    ; tb = 转换出的整数
  40125d:	8d 40 ff             	lea    -0x1(%rax),%eax    ; ta = (int)(ta - 1)
  401260:	3d e8 03 00 00       	cmp    $0x3e8,%eax    ; ta - 0x3e8
  401265:	76 05                	jbe    40126c <secret_phase+0x2a>   ; ta <= 0x3e8
  401267:	e8 ce 01 00 00       	callq  40143a <explode_bomb>
  40126c:	89 de                	mov    %ebx,%esi    ; %esi = tb
  40126e:	bf f0 30 60 00       	mov    $0x6030f0,%edi   ; %edi = 0x6030f0
  401273:	e8 8c ff ff ff       	callq  401204 <fun7>
  401278:	83 f8 02             	cmp    $0x2,%eax    ; ta - 2
  40127b:	74 05                	je     401282 <secret_phase+0x40>   ; ta == 2 才行
