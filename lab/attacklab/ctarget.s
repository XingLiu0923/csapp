...
0000000000401a40 <Gets>:
  ...
  401a4e:	00 00 00 
  401a51:	48 89 fb             	mov    %rdi,%rbx        # tb = %rdi
  401a54:	eb 11                	jmp    401a67 <Gets+0x27>

  401a56:	48 8d 6b 01          	lea    0x1(%rbx),%rbp   # %rbp = tb + 1
  401a5a:	88 03                	mov    %al,(%rbx)       # (tb) = ta
  401a5c:	0f b6 f8             	movzbl %al,%edi         # %edi = ta
  ...
  401a78:	83 f8 0a             	cmp    $0xa,%eax    # 到达尾部'\n'
